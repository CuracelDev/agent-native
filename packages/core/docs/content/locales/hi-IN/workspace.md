...
> **कौन सा कार्यक्षेत्र दस्तावेज़?** यह पृष्ठ **अनुकूलन परत** को कवर करता है - कार्यक्षेत्र _क्या_है। परिनियोजन आकार (एक मोनोरेपो, कई ऐप्स) के लिए [Multi-App Workspaces](/docs/multi-app-workspace) देखें; शासन के लिए (कौन समीक्षा करता है, अनुमोदन करता है और उसका मालिक है) [Workspace Governance](/docs/workspace-management) देखें।
