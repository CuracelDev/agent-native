...
يؤدي هذا إلى جعل عملية الطرح آمنة على الرغم من تسجيل خروج الأشخاص. **من المتوقع تسجيل الخروج.** عندما يقوم أحد التطبيقات بتشغيل هذا، تنتهي الجلسات الحالية ويعيد المستخدمون المصادقة من خلال Dispatch. لكنهم دائمًا ما يقومون بتسجيل الدخول مرة أخرى إلى **نفس الحساب المطابق للبريد الإلكتروني، مع الحفاظ على جميع بياناتهم سليمة**، لأن صفوف الهوية لا تتم إضافتها إلا إلى_ — ولا يتم تدميرها أو إعادة تسميتها أو إعادة تعيينها مطلقًا.
